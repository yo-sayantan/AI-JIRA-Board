...
// PR Readiness Reports for file:// mode — window.__JIRA_PR_REPORTS__, regenerated by
// local-runner/sync-reports.mjs. Optional: a 404 (no reports yet) just leaves the global unset.
const REPORTS_SCRIPT_SRC = '../jira-intern/reports/index.js'
...
function injectDataScript(): Plugin {
  return {
    ...
    transformIndexHtml() {
      return [
        { tag: 'script', attrs: { src: DATA_SCRIPT_SRC }, injectTo: 'head-prepend' },
        { tag: 'script', attrs: { src: REPORTS_SCRIPT_SRC }, injectTo: 'head-prepend' },
      ]
    },
  }
}
